...
# The first version 10/12 Saturday
# user can see the first three chunks of the extracted text
# user can see the total number of chunks created
# user can see the source of the document
# with options between mmr and cos similarity
# user can choose the preferred retrieve method
# the answer is displayed based on the selected retrieve method

# cannot leave the button selected
# cannot send the feedback to a specific json file (buttons are displayed but not working)
# cannot show the score of retrieved documents
        ...
        if query:
            ...
            if qa_mmr and qa_cos:
                ...
                if st.session_state.selected == "MMR":
                    mmr_button_color = "danger"  # Red color for selected
                    cos_button_color = "secondary"  # Default for unselected
                elif st.session_state.selected == "Cosine":
                    mmr_button_color = "secondary"
                    cos_button_color = "danger"
                else:
                    mmr_button_color = "secondary"
                ...
                # Use the selected result to generate the final answer
